...
//                            "packagesDirectory": "."
				...
				if (typeof descriptor.mappings[browserMappingKey + "[platform=linux&arch=x64]"] === "undefined") {
					...
					if (self._options.browserRelease === "nightly") {
						...
						descriptor.mappings[browserMappingKey + "[platform=linux&arch=x64]"] = "http://download.cdn.mozilla.net/pub/mozilla.org/firefox/releases/" + descriptor.config.browser.version + "/linux-x86_64/en-US/firefox-" + descriptor.config.browser.version + ".tar.bz2";
					}
				}
    ...
    if (VERBOSE) console.log("[it.pinf.org.mozilla.firefox] Server running at: http://127.0.0.1:" + PORT + "/");
